...
SELECT has_column(        'hpms_aadt_combination', 'segment_id' );
SELECT col_type_is(       'hpms_aadt_combination', 'segment_id', 'integer' );
SELECT col_hasnt_default( 'hpms_aadt_combination', 'segment_id' );
